    ...
    return(
        <View style={{flex:1}}>
            ...
            >
                ...
                <Text style={texto.titulo}>Pasta</Text>
                <Image
                    ...
                    <Text style={texto.modelo}>Tipo de Material</Text>
                        ...
                        <Modal
                            ...
                            <View style={modal.modalBackground}>
                                <View style={modal.caixaMaterial}>
                                    ...
                                    <View style={modal.checks}>
                                        <CheckBox
                                            checked={opcaoEscolhida1 === 'Couchê 250g '}
                                            onPress={() => handleOpcaoEscolhida1('Couchê 250g ')}
                                        />
                                        <Text style={{marginTop: 18,}}>Couchê 250g </Text>
                                    </View>
                                    <View style={modal.checks}>
                                        <CheckBox
                        ...
                        <View style={modal.modalBackground}>
                                <View style={modal.caixaFormato}>
                                    <View style={modal.checks}>
                                        <CheckBox
                                        checked={opcaoEscolhida2 === '220x310mm '}
                                        onPress={() => handleOpcaoEscolhida2('220x310mm ')}
                                        />
                                        <Text style={{marginTop: 18,}}>220x310mm </Text>
                                    </View>
                                </View>
                            </View>
                            </Modal>
                        ...
                        <View style={modal.modalBackground}>
                                <View style={modal.caixaCor}>
                                    <View style={modal.checks}>
                                        ...
                                        />
                                        <Text style={{marginTop: 18,}}>4x0 cores </Text>
                                    </View>
                                    <View style={modal.checks}>
                                        <CheckBox
                                            checked={opcaoEscolhida3 === '4x4 cores '}
                                            onPress={() => handleOpcaoEscolhida3('4x4 cores ')}
                                        />
                                        <Text style={{marginTop: 18,}}>4x4 cores </Text>
                                    </View>
                                </View>
                            </View>
                            </Modal>
                        ...
                        <View style={modal.modalBackground}>
                                <View style={modal.caixaAcabamento}>
                                    <View style={modal.checks}>
                                        <CheckBox
                                        checked={opcaoEscolhida4 === 'Faca Padrão '}
                                        onPress={() => handleOpcaoEscolhida4('Faca Padrão ')}
                                        />
                                        <Text style={{marginTop: 18,}}>Faca Padrão </Text>
                                    </View>
