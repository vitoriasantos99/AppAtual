    ...
    return(
        <View style={{flex:1}}>
            ...
            >
                ...
                <Text style={texto.titulo}>Envelope</Text>
                <Image
                    ...
                    <Text style={texto.modelo}>Tipo de Material</Text>
                            ...
                            <View style={modal.modalBackground}>
                                <View style={modal.caixaMaterial}>
                                    <View style={modal.checks}>
                                        <CheckBox
                                        checked={opcaoEscolhida1 === 'Sulfite 80g '}
                                        onPress={() => handleOpcaoEscolhida1('Sulfite 80g ')}
                                        />
                                        <Text style={{marginTop: 18,}}>Sulfite 80g </Text>
                                    </View>
                                    <View style={modal.checks}>
                                        <CheckBox
                        ...
                        <View style={modal.modalBackground}>
                                <View style={modal.caixaFormato}>
                                    <View style={modal.checks}>
                                        <CheckBox
                                        checked={opcaoEscolhida2 === '114x229mm '}
                                        onPress={() => handleOpcaoEscolhida2('114x229mm ')}
                                        />
                                        <Text style={{marginTop: 18,}}>114x229mm </Text>
                                    </View>
                                    <View style={modal.checks}>
                                        <CheckBox
