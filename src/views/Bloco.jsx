                    ...
                    <Text style={texto.modelo}>Tipo de Material</Text>
                            ...
                            <View style={modal.modalBackground}>
                                <View style={modal.caixaMaterial}>
                                    <View style={modal.checks}>
                                        <CheckBox
                                        checked={opcaoEscolhida1 === 'Sulfite 75g '}
                                        onPress={() => handleOpcaoEscolhida1('Sulfite 75g ')}
                                        />
                                        <Text style={{marginTop: 18,}}>Sulfite 75g </Text>
                                    </View>
                                    <View style={modal.checks}>
                                        <CheckBox
                                    ...
                                    <View style={modal.checks}>
                                        <CheckBox
                                            checked={opcaoEscolhida1 === '1ª via Branca, 2ª via amarela, 3ª via Azul (56g) '}
                                            onPress={() => handleOpcaoEscolhida1('1ª via Branca, 2ª via amarela, 3ª via Azul (56g) ')}
                                        />
                                        <Text style={{marginTop: 18,}}>1ª via Branca, 2ª via amarela, 3ª via Azul (56g) </Text>
                                    </View>
                                    <View style={modal.checks}>
                                        <CheckBox
                                            checked={opcaoEscolhida1 === '1ª via Branca, 2ª via amarela (56g) '}
                                            onPress={() => handleOpcaoEscolhida1('1ª via Branca, 2ª via amarela (56g) ')}
                                        />
                                        <Text style={{marginTop: 18,}}>1ª via Branca, 2ª via amarela (56g) </Text>
                                    </View>
                                </View>
                            </View>
                        </Modal>
                        ...
                        <View style={modal.modalBackground}>
                                <View style={modal.caixaFormato}>
                                    <View style={modal.checks}>
                                        <CheckBox
                                        checked={opcaoEscolhida2 === '70x 105 mm '}
                                        onPress={() => handleOpcaoEscolhida2('70x 105 mm ')}
                                        />
                                        <Text style={{marginTop: 18,}}>70x 105 mm </Text>
                                    </View>
                                    <View style={modal.checks}>
                                        <CheckBox
                                            checked={opcaoEscolhida2 === '100x148 mm '}
                                            onPress={() => handleOpcaoEscolhida2('100x148 mm ')}
                                        />
                                        <Text style={{marginTop: 18,}}>100x148 mm </Text>
                                    </View>
                                    <View style={modal.checks}>
                                        <CheckBox
                        ...
                        <View style={modal.modalBackground}>
                                <View style={modal.caixaCor}>
                                    ...
                                    <View style={modal.checks}>
                                        <CheckBox
                                            checked={opcaoEscolhida3 === '4x0 cores '}
                                            onPress={() => handleOpcaoEscolhida3('4x0 cores ')}
                                        />
                        ...
                        <View style={modal.modalBackground}>
                                <View style={modal.caixaAcabamento}>
                                    <View style={modal.checks}>
                                        <CheckBox
                                        checked={opcaoEscolhida4 === 'Blocagem com 100 folhas '}
                                        onPress={() => handleOpcaoEscolhida4('Blocagem com 100 folhas ')}
                                        />
                                        <Text style={{marginTop: 18,}}>Blocagem com 100 folhas </Text>
                                    </View>
                                    <View style={modal.checks}>
                                        <CheckBox
                                            checked={opcaoEscolhida4 === 'Blocagem com 50 folhas '}
                                            onPress={() => handleOpcaoEscolhida4('Blocagem com 50 folhas ')}
                                        />
                                        <Text style={{marginTop: 18,}}>Blocagem com 50 folhas </Text>
                                    </View>
                                    <View style={modal.checks}>
                                        <CheckBox
                                            checked={opcaoEscolhida4 === 'Blocagem com 50 folhas – 2 vias – serrilhado  '}
                                            onPress={() => handleOpcaoEscolhida4('Blocagem com 50 folhas – 2 vias – serrilhado  ')}
                                        />
                                        <Text style={{marginTop: 18,}}>Blocagem com 50 folhas – 2 vias – serrilhado  </Text>
                                    </View>
                                    <View style={modal.checks}>
                                        <CheckBox
                                            checked={opcaoEscolhida4 === 'Blocagem com 50 folhas – 2 vias – serrilhado – numerado '}
                                            onPress={() => handleOpcaoEscolhida4('Blocagem com 50 folhas – 2 vias – serrilhado – numerado ')}
                                        />
                                        <Text style={{marginTop: 18,}}>Blocagem com 50 folhas – 2 vias – serrilhado – numerado </Text>
                                    </View>
                                </View>
                            </View>
                            </Modal>
