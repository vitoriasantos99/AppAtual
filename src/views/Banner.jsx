    ...
    return(
        <View style={{flex:1}}>
            ...
            >
                ...
                <Text style={texto.titulo}>Banner</Text>
                <Image
                    ...
                    <Text style={texto.modelo}>Tipo de Material</Text>
                            ...
                            <View style={modal.modalBackground}>
                                <View style={modal.caixaMaterial}>
                                    <View style={modal.checks}>
                                        <CheckBox
                                        checked={opcaoEscolhida1 === 'Lona brilho 340g'}
                                        onPress={() => handleOpcaoEscolhida1('Lona brilho 340g')}
                                        containerStyle={{ backgroundColor: 'transparent', borderWidth: 0 }}
                                        />
                                        <Text style={{marginTop: 18, color: "#fff"}}>Lona brilho 340g</Text>
                                    </View>
                                    <View style={modal.checks}>
                                        <CheckBox
                                            checked={opcaoEscolhida1 === 'Lona fosca 340g '}
                                            onPress={() => handleOpcaoEscolhida1('Lona fosca 340g ')}
                                            containerStyle={{ backgroundColor: 'transparent', borderWidth: 0 }}
                                        />
                                        <Text style={{marginTop: 18, color: "#fff"}}>Lona fosca 340g </Text>
                                    </View>
                                </View>
                            </View>
                        </Modal>
                        ...
                        <View style={modal.modalBackground}>
                                <View style={modal.caixaFormato}>
                                    <View style={modal.checks}>
                                        <CheckBox
                                        checked={opcaoEscolhida2 === '400x600mm'}
                                        onPress={() => handleOpcaoEscolhida2('400x600mm')}
                                        containerStyle={{ backgroundColor: 'transparent', borderWidth: 0 }}
                                        />
                                        <Text style={{marginTop: 18, color: "#fff"}}>400x600mm</Text>
                                    </View>
                                    <View style={modal.checks}>
                                        <CheckBox
                                            checked={opcaoEscolhida2 === '600x900mm '}
                                            onPress={() => handleOpcaoEscolhida2('600x900mm ')}
                                            containerStyle={{ backgroundColor: 'transparent', borderWidth: 0 }}
                                        />
                                        <Text style={{marginTop: 18, color: "#fff"}}>600x900mm </Text>
                                    </View>
                                    <View style={modal.checks}>
                                        <CheckBox
                                            checked={opcaoEscolhida2 === '700x1000mm '}
                                            onPress={() => handleOpcaoEscolhida2('700x1000mm ')}
                                            containerStyle={{ backgroundColor: 'transparent', borderWidth: 0 }}
                                        />
                                        <Text style={{marginTop: 18, color: "#fff"}}>700x1000mm </Text>
                                    </View>
                                    <View style={modal.checks}>
                                        <CheckBox
                                            checked={opcaoEscolhida2 === '1000x1500mm '}
                                            onPress={() => handleOpcaoEscolhida2('1000x1500mm')}
                                            containerStyle={{ backgroundColor: 'transparent', borderWidth: 0 }}
                                        />
                                        <Text style={{marginTop: 18, color: "#fff"}}>1000x1500mm </Text>
                                    </View>
                                </View>
                            </View>
                            </Modal>
                        ...
                        <View style={modal.modalBackground}>
                                <View style={modal.caixaCor}>
                                    <View style={modal.checks}>
                                        ...
                                        containerStyle={{ backgroundColor: 'transparent', borderWidth: 0 }}
                                        />
                                        <Text style={{marginTop: 18, color: "#fff"}}>4x0 cores (Colorido frente) </Text>
                                    </View>
                                </View>
                            </View>
                            </Modal>
                        ...
                        <View style={modal.modalBackground}>
                                <View style={modal.caixaAcabamento}>
                                    <View style={modal.checks}>
                                        <CheckBox
                                        checked={opcaoEscolhida4 === 'Bastão/Cordão '}
                                        onPress={() => handleOpcaoEscolhida4('Bastão/Cordão ')}
                                        containerStyle={{ backgroundColor: 'transparent', borderWidth: 0 }}
                                        />
                                        <Text style={{marginTop: 18, color: "#fff"}}>Bastão/Cordão </Text>
                                    </View>
                                    <View style={modal.checks}>
                                        <CheckBox
                                            checked={opcaoEscolhida4 === 'Ilhós '}
                                            onPress={() => handleOpcaoEscolhida4('Ilhós ')}
                                            containerStyle={{ backgroundColor: 'transparent', borderWidth: 0 }}
                                        />
                                        <Text style={{marginTop: 18, color: "#fff"}}>Ilhós </Text>
                                    </View>
                                </View>
                            </View>
                            </Modal>
